...
describe RecordsController do
  ...
  let(:valid_attributes) { { "number" => "1", "io_type" => "1", "act_type" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved record as @record" do
        ...
        post :create, {:record => { "warehouse" => "invalid value" }}, valid_session
        expect(assigns(:record)).to be_a_new(Record)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested record" do
        ...
        expect_any_instance_of(Record).to receive(:update).with({ "number" => "1" })
        put :update, {:id => record.to_param, :record => { "number" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the record as @record" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Record.any_instance.stub(:save).and_return(false)
        put :update, {:id => record.to_param, :record => { "warehouse" => "invalid value" }}, valid_session
        expect(assigns(:record)).to eq(record)
      end
